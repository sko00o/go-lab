...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x60, 0x52, 0x60, 0xd4, 0xe0, 0x0c, 0x02, 0xb3, 0x8d, 0xfa, 0x18, 0x21, 0x6a, 0x82, 0x21, 0x66,
	0x0b, 0xd9, 0x71, 0xb1, 0x7a, 0xa4, 0xe6, 0xe4, 0xe4, 0x0b, 0x09, 0xe8, 0x25, 0x16, 0x64, 0xea,
	0x21, 0x69, 0x97, 0xc2, 0x10, 0x51, 0x12, 0x6c, 0xba, 0xfc, 0x64, 0x32, 0x13, 0xb7, 0x10, 0xa7,
	0x7e, 0x99, 0xa1, 0x7e, 0x06, 0x58, 0x9b, 0x3d, 0x17, 0x0b, 0x48, 0x05, 0x51, 0xda, 0x85, 0xc1,
	0xda, 0x79, 0x95, 0x38, 0x40, 0xda, 0x53, 0x93, 0x33, 0xf2, 0xad, 0x18, 0xb5, 0x92, 0xd8, 0xc0,
	0x4e, 0x37, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x08, 0x32, 0x66, 0x53, 0xee, 0x00, 0x00, 0x00,
}
...
func (c *echoServiceClient) Hello(ctx context.Context, in *EchoMessage, opts ...grpc.CallOption) (*EchoMessage, error) {
	out := new(EchoMessage)
	err := c.cc.Invoke(ctx, "/api.EchoService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EchoService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.EchoService/Hello",
	}
